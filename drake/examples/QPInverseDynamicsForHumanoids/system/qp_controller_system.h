...
class QPControllerSystem : public systems::LeafSystem<double> {
 public:
   ...
   */
  inline const systems::InputPortDescriptor<double>& get_input_port_qp_input() const {
   ...
   */
  inline const systems::OutputPortDescriptor<double>& get_output_port_qp_output() const {
