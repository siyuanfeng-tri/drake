...
JointLevelControllerSystem::JointLevelControllerSystem(const RigidBodyTree<double>& robot)
  : robot_(robot) {
...
void JointLevelControllerSystem::DoCalcOutput(const Context<double>& context,
...
std::unique_ptr<SystemOutput<double>> JointLevelControllerSystem::AllocateOutput(
