...
class JointLevelControllerSystem : public systems::LeafSystem<double> {
 public:
   ...
   */
  inline const systems::InputPortDescriptor<double>& get_input_port_qp_output() const {
   ...
   */
  inline const systems::OutputPortDescriptor<double>& get_output_port_atlas_command()
      const {
