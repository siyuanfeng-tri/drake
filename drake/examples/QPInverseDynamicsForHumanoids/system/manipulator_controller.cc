...
ManipulatorController::ManipulatorController(
  ...
  this->set_name("ManipulatorController");
  ...
  plan_eval_ = builder.AddSystem<ManipulatorPlanEval>(
  ...
  input_port_index_move_joints_command_ =
      builder.ExportInput(plan_eval_->get_input_port_move_joints_command());

  input_port_index_move_ee_command_ =
      builder.ExportInput(plan_eval_->get_input_port_move_end_effector_command());
...
void ManipulatorController::Initialize(
