...
template <typename DerivedQ, typename DerivedV, typename DerivedVd>
void integrate_state_floating_base_rpy(double dt,
...
template <typename DerivedQ, typename DerivedV, typename DerivedVd>
void integrate_state_floating_base_quaternion(
    double dt, Eigen::MatrixBase<DerivedQ>& q, Eigen::MatrixBase<DerivedV>& v,
    const Eigen::MatrixBase<DerivedVd>& vd) {
